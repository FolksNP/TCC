                ...
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card mb-5" style="background: var(--bs-success);">
                        <div class="card-body p-sm-5" style="height: 634.15px;width: 455px;background: var(--bs-success);">
                            ...
                            <form action="cadLogin.act.php" method="post">
                                ...
                                <input class="form-control" type="email" placeholder="Confirme Email" name="conEmail" style="margin-bottom: 7px;margin-top: 15px;">
                                <input class="form-control" type="password" placeholder="Senha" name="senha" style="margin-bottom: 7px;margin-top: 15px;">
                                <input class="form-control" type="password" placeholder="Confirme Senha" name="conSenha" style="margin-bottom: 7px;margin-top: 15px;">
                                <input class="form-control" type="text" placeholder="Usuário (Opcional)" name="usuario" style="margin-bottom: 7px;margin-top: 15px;">
                                <div class="mb-3"></div>
                                <div class="mb-3"></div>
                                <div></div>
